...
<label for='payment'>Payment: </label><label><input type=radio name='payment' value='Online' required>Online</label>
                                        <label><input type=radio name='payment' value='COD' required>COD</label><br>
	...
	<?php
		if(isset($_GET['submit'])){
			...
			$sqlp="delete from cart where customer_id='$custID'";
